...
$register[]=".tv,1:2:5,39.99:74.99:179.99";
...
$vendoremail="sales@yoursite.com";               // Your email to receive orders
$vendoremail2="";                                // Optional second admin email address
$vendorcompany="Your Company";
$columns=3;                                      // Number of columns in domain extensions table
$csymbol="$"; 		                               // Symbol to use for currency. Displayed before amount.
...
$payprocess="Paypal";            			 			   	 // Set to "2CO", "Paypal",  "WpFuturepay", "Paysystems", "Stormpay", "Nochex", "Authorize",
...
$payprocessnames="";														 // For multiple payment processors set titles to be used in drop down menu.
