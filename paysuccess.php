<?php
  ...
  if ($_SESSION['updatedOrders'] && $_SESSION['userPresent']) {
    ...
    //   if (strpos($key, "domain") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "hostdesc") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "hostprice") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "hostrecurr") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "regtype") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "regperiod") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "regprice") === 0) unset($_SESSION[$key]);
    //   if (strpos($key, "hostsetup") === 0) unset($_SESSION[$key]);
    //   // if (strpos($key, "") === 0) unset($_SESSION[$key]);
    // }
